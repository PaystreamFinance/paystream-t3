...
function getLendingPosition(traderPosition: TraderPositionUI, decimals: number): PositionData {
    return { 
        amount: bnToNumber(traderPosition.lending.deposits, decimals),
        action_amount: traderPosition.lending.deposits - traderPosition.lending.collateral.amount
    }
}

function getP2PLendingPosition(traderPosition: TraderPositionUI, decimals: number): PositionData {
    return {
...
function getP2PBorrowPosition(traderPosition: TraderPositionUI, decimals: number): PositionData {
    return {
